...
// is waly code se sidebar leke apne waly mai lagana hai
...
//     // Feature filter
//     if (featureFilters.includes("With DVR") && item.dvr !== "Archive enabled") {
//       return false
//     }
//     if (featureFilters.includes("With Transcoder") && item.transcode !== "Transcoder enabled") {
//       return false
//     }
...
//   // Feature counts for filters
//   const featureCounts = {
//     "With DVR": streamData.filter((item) => item.dvr === "Archive enabled").length,
//     "With Transcoder": streamData.filter((item) => item.transcode === "Transcoder enabled").length,
//   }
...
//           <div className="mt-1">
//             <span
//               className={`text-${record.status === "Online" ? "green" : record.status === "Waiting" ? "yellow" : "red"}-500`}
//             >
//               {record.status}
//             </span>
//           </div>
...
//               <div className="mt-2">
//                 <div>
//                   Thumbnails: <span className="text-red-500">Off</span>
//                 </div>
//                 <div>
//                   Authorization: <span className="text-red-500">Off</span>
//                 </div>
//                 <div>
//                   Content is DRM-free <span className="text-blue-500 cursor-pointer">Turn on DRM</span>.
//                 </div>
//               </div>
//               <div
//                 className="text-blue-600 cursor-pointer mt-1 flex items-center"
...
//             <>
//               <Button type="primary" icon={<EditOutlined />} size="small" className="bg-blue-500">
//                 Edit
//               </Button>
//               <Button type="primary" icon={<CheckOutlined />} size="small" className="bg-green-500">
//                 Select
//               </Button>
//               <Button
//                 icon={<CloseOutlined />}
...
//             {selectedRowKey === record.key ? (
//               <>
//                 <Button type="primary" icon={<EditOutlined />} size="small" className="bg-blue-500 mr-2">
//                   Edit
//                 </Button>
//                 <Button type="primary" icon={<CheckOutlined />} size="small" className="bg-green-500 mr-2">
//                   Select
//                 </Button>
//                 <Button
//                   icon={<CloseOutlined />}
...
//                   <div className="w-4 h-4 rounded-full bg-blue-600 ml-auto"></div>
//                 </div>
//                 <Button icon={<ReloadOutlined />} shape="circle" className="mr-2" />
//                 <Button icon={<PlayCircleOutlined />} shape="circle" className="mr-2" />
//                 <Button
//                   icon={expandedRows[record.key] ? <span>▲</span> : <span>▼</span>}
//                   shape="circle"
//                   onClick={(e) => toggleRowExpansion(record.key, e)}
//                 />
//               </>
...
//               <h1 className="text-2xl font-semibold mb-2 md:mb-0">Streams</h1>
//               <div className="overflow-x-auto">
//                 <div className="flex space-x-3 border border-gray-300 rounded-full whitespace-nowrap">
//                   <div className="px-3 font-medium py-1 border-gray-400">23.09</div>
...
//               <button className="text-xl font-bold px-3 py-1 text-white bg-[#04004F] rounded-md flex items-center justify-center min-w-[40px]">
//                 <IoAddCircleOutline />
//               </button>
...
//             {/* Search and other features options */}
//             <div className="flex flex-col md:flex-row md:justify-between my-4 gap-3">
...
//                   <Button className="flex items-center">
//                     <span className="mr-1">
//                       Sort By: {sortField === "name" ? "A-Z" : sortField === "bitrate" ? "Bitrate" : "Clients"}
//                     </span>{" "}
//                     <DownOutlined />
//                   </Button>
//                 </Dropdown>
...
//                 className="border border-gray-300 rounded-lg"
//                 size={compactView ? "small" : "middle"}
//                 rowClassName={(record) => `cursor-pointer ${selectedRowKey === record.key ? "bg-blue-50" : ""}`}
//                 onRow={(record) => ({
...
//                 <span className="mr-2">Per page</span>
//                 <Select value={itemsPerPage} onChange={setItemsPerPage} className="w-24">
//                   {paginationOptions.map((option) => (
//                     <Select.Option key={option} value={option}>
//                       {option}
//                     </Select.Option>
