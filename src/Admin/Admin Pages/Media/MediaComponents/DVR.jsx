...
import { Tabs, Input, Button, Select, TimePicker, Row, Col, Tooltip } from 'antd';
...
function DVR() {
    ...
    const [schedule, setSchedule] = useState([
        { startTime: dayjs().tz('Asia/Karachi').startOf('day').add(15 * 60 + 42, 'minute'), endTime: dayjs().tz('Asia/Karachi').startOf('day').add(23 * 60 + 59, 'minute') },
        { startTime: null, endTime: dayjs().tz('Asia/Karachi').startOf('day').add(23 * 60 + 59, 'minute') },
    ]);

    const handleAddScheduleRange = () => {
        setSchedule([...schedule, { startTime: null, endTime: dayjs().tz('Asia/Karachi').startOf('day').add(23 * 60 + 59, 'minute') }]);
    };
        ...
        <AppLayout>
            ...
            <div className="p-4 h-[calc(100vh-150px)] overflow-y-auto bg-white">
                <div className="bg-blue-50 border border-blue-200 rounded-md p-3 mb-4">
                    ...
                    The DVR player has been moved to the <Link to="/media/overview" className="text-blue-700 underline">Overview page</Link>.
                ...
                <div className="mb-6">
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="globalDvrConfig">
                        Global DVR config
                    </label>
                    <Select
                        id="globalDvrConfig"
                    ...
                    <Link to="#" className="text-blue-500 text-sm mt-1 inline-block">Edit DVR configurations</Link>
                </div>
                ...
                <div className="mb-6">
                    ...
                    />
                    <p className="text-gray-500 text-xs mt-1">Where the archive is stored</p>
                </div>

                <div className="mb-6">
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="archiveCachePath">
                        SSD disk cache
                    ...
                    <p className="text-gray-500 text-xs mt-1">
                        Cache requested archive segments. Useful even if no local dvr defined, for proxied remote dvr.
                    </p>
                </div>
                ...
                <div className="mb-6">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <Button icon={<PlusOutlined />} size="small" onClick={handleAddScheduleRange}>
                            Add Schedule Range
                        </Button>
                    </div>
