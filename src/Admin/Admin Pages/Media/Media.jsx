...
import { Layout, theme, Tabs, Input, Button, Table, Tag, Space, Select, Dropdown, Radio, Drawer } from "antd"
import {
  SearchOutlined,
  FilterOutlined,
  ReloadOutlined,
  ...
  const mobileColumns = [
    {
      ...
      render: (text, record) => (
        <div>
          ...
          <div className="text-xs text-gray-500 mt-1 ml-7">Always started (Static)</div>
        ...
        <div>
          ...
          {expandedRows[record.key] ? (
            <>
              ...
              >
                Hide <span><FaChevronCircleDown className="text-xs"/></span>
              </div>
            </>
          ) : (
            <div
              ...
              onClick={(e) => toggleRowExpansion(record.key, e)}
            >
              More <span><FaChevronCircleUp className="text-xs"/></span>
            </div>
          )}
        </div>
      ),
          ...
          >
            ...
            <div className={`flex flex-col md:flex-row md:justify-between my-4 ${isMobile ? "px-4" : ""}`}>
              ...
              <div className="flex space-x-2 mt-2 md:mt-0 overflow-x-auto pb-2 md:pb-0">
                <Button
                  icon={<MenuOutlined />}
                  style={!compactView ?{backgroundColor: "#08027d", color: "white"}: ""}
                ...
                {isMobile ? (
                  <Button 
                  className="flex items-center whitespace-nowrap" onClick={() => setSortDrawerVisible(true)}>
            ...
            >
              <Table
                ...
                rowClassName={(record) => (selectedRowKeys.includes(record.key) ? "bg-blue-50" : "")}
                onRow={(record) => ({
            ...
            {selectedRowKeys.length > 0 && (
              <div className="bg-gray-100 p-4 flex justify-between items-center">
                <div>
                  <span className="font-medium">Selected:</span> {selectedRowKeys.length} stream
                </div>
            ...
            {/* Pagination bottom */}
            <div
              className={`flex flex-col md:flex-row md:justify-between items-start md:items-center mt-6 ${isMobile ? "px-4" : ""}`}
            >
            ...
            >
              <div className="p-4">
                ...
                <div className="flex justify-end mt-6">
                  ...
                  <Button type="primary" onClick={() => setSortDrawerVisible(false)} className="bg-blue-600">
                    Apply
                  </Button>
                </div>
              </div>
